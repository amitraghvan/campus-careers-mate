/**
 * StatsCards — Dashboard overview metrics.
 * Shows total, upcoming, selected, and in-progress counts.
 */
        ...
        >
          ...
          <div className="relative">
            <div className="flex items-center justify-between mb-4">
              <div
                className={`h-10 w-10 rounded-lg bg-gradient-to-br ${s.gradient} flex items-center justify-center`}
              >
